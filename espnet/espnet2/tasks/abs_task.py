...
# import galore_adamw
from espnet2.optimizers.galore_adamw import GaLoreAdamW
...
class AbsTask(ABC):
    ...
    def build_optimizers(
        ...
        is_named_optimizer = issubclass(optim_class, NamedOptimizer)

        if args.sharded_ddp:
            if is_named_optimizer:
                raise NotImplementedError(
                    "Named optimizers such as GaLoreAdamW are not supported "
                    "with sharded_ddp."
                )
